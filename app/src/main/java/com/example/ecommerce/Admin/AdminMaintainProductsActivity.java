...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    private Button apply,delete_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apply =(Button)findViewById(R.id.apply_change_btn);
    ...
    private void deleteThisProduct() {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                finish();
                Toast.makeText(AdminMaintainProductsActivity.this,"this product is deleted",Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(AdminMaintainProductsActivity.this,"Change apply successfully",Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(AdminMaintainProductsActivity.this, AdminCategoryActivity.class);
                        startActivity(intent);
                        finish();
